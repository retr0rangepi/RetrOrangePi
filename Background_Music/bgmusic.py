...
emulatornames = ["abuse","drastic","kodi.bin","residualvm","amiberry", "wolf4sdl-3dr-v14", "wolf4sdl-gt-v14", "wolf4sdl-spear", "wolf4sdl-sw-v14", "xvic","xvic cart","xplus4","xpet","x128","x64sc","x64","PPSSPPSDL","prince","OpenBOR","Xorg","retroarch","ags","uae4all2","uae4arm","capricerpi","linapple","hatari","stella","atari800","xroar","vice","daphne.bin","reicast","pifba","osmose","gpsp","jzintv","basiliskll","mame","advmame","dgen","openmsx","mupen64plus","gngeo","dosbox","ppsspp","simcoupe","scummvm","snes9x","pisnes","frotz","fbzx","fuse","gemrb","cgenesis","zdoom","eduke32","lincity","love","kodi","alephone","micropolis","openbor","openttd","opentyrian","cannonball","tyrquake","ioquake3","residualvm","xrick","sdlpop","uqm","stratagus","wolf4sdl","solarus_run","mplayer","zesarux","mpv","vlc","tyr-quake","quake2","abbayev2","abe","alephone","amphetamine","barrage","bs","bloboats","bombermaaan","breaker","burgerspace","capitansevilla","caveexpress","cdogs-sdl","chocolate-doom","chocolate-heretic","chocolate-strife","corsixth","crack-attack","crispy-doom","devilutionx","digger","d2x-rebirth","ecwolf","edgar","etr","f1spirit","f2bgl","freeciv","freedink","freegish","freesynd","fruity","funnyboat","gemrb","giana","goonies","hcl","heboris","hurricanlinux","jumpnbump","kodi-gbm","lbreakout2","lgeneral","lincity-ng","lmarbles","ltris","manaplus","mayhem2-pi","micropolis","minecraft","minetest","minislug","mog","MysticMine","nblood","nKaruga.elf","nx","openblok","OpenBOR","OpenFodder","openjazz","parsec","openpht","openttd","opentyrian","openxcom","pekka-kana-2","pingus","powermanga","prboom-plus","prototype","python2","ioquake3.arm","rawgl","rs","retrobattle","ricky","roadfighter","rockbot","rocksndiamonds","rott-darkwar","rott-huntbgin","rott","rott-shareware","bomber","prince","seahorse-adventures","shiromino","sm64ex.arm","smw","bgdi","srb2","supertux2","Texmaster2009","tf","uqm","vorton","VVVVVV","warmux","wizznic","box86","xash3d","xgalaga++","xrick","quake2","Zelda-3T","zelda","ZeldaNSQ","Zelda-Picross"]
