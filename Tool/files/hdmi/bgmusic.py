...
startsong = "nes.ogg" # if this is not blank, this is the EXACT, CaSeSeNsAtIvE filename of the song you always want to play first on boot.
...
while True:
	...
	if os.path.exists('/home/pi/RetroPie/music/DisableMusic'):
		#print "DisableMusic found!"
		if mixer.music.get_busy():
			mixer.music.stop();
		while (os.path.exists('/home/pi/RetroPie/music/DisableMusic')):
			time.sleep(15)
